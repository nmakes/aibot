...
class Expr:
    ...
    '''
        ...
        Init will be executed when <ClassName>() is called. Call will be executed when <ObjectName>() will be called.
        Here <ClassName>() represents the call of the constructor of the class <ClassName>, and <ObjectName>() represents the object
        with name <ObjectName> followed by a list of arguments so as to make it a function call.
...
readPredicateFile(["Human  (  x  )     :   x is a    human", "Born(x,y):   x was born in the year y"])
...
op = "Human"
arglist = ["nav", "vig", "mac", "abc"]

strClassMaker = "class " + op + ":\n\tdef __init__(self,op,*args):\n\t\tself.op=op\n\t\tself.args=args\n\t\tprint 'object created'"
...
def runCommand(commStr):

    print commStr
    exec(commStr)

# print "---- RUNNING CLASS CODE ----"
# print strClassMaker
# print "----------------------------"
exec(strr)
# exec("Human(op,args)")
